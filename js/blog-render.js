/* ============================================================
   BLOG-RENDER.JS -- Renders blog page from localStorage data
...
(function () {
  ...
  if (!blogs) return; // No admin data — keep hardcoded HTML
  ...
  var grid = document.querySelector('.blog-featured + .blog-tabs + .grid-3') ||
             document.querySelector('.section .grid-3');

  // Find the grid that is after the blog-tabs
